...
const experience = [
  {
    ...
    company: "Precision Automation Consults",
    period: "January 2025 — Present",
    type: "Developer",
    companyIcon: "mdi:factory",   
    companyColor: "from-green-500 to-green-600",
    description: "Delivered high-impact projects across web and mobile platforms, specializing in scalable API development and cloud integration with AWS and GCP.",
    achievements: [
  ...
  {
    role: "Fullstack Developer – Learning Management System",
    company: "Educraft",
    period: "July 2019 — Present",
    type: "Full-time",
    companyColor: "from-blue-500 to-blue-600",
    companyIcon: "mdi:school",  
    description: "Spearheaded development of a scalable Learning Management System, delivering modular frontend and backend solutions that empower online education.",
    achievements: [
      "Designed and implemented key features using Vue.js and Laravel",
      "Collaborated with UI/UX designers to enhance user experience",
      "Integrated API endpoints for seamless third-party integrations",
      "Provided training and ongoing support for platform users"
    ],
    technologies: ["Vue.js", "Laravel", "PHP", "MySQL", "REST APIs", "Docker", "Agile Development"]
  },
];
