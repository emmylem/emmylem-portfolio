                ...
                <div className="space-y-4 md:space-y-6">
                  <div>
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 md:mb-4 text-gray-900 dark:text-white flex items-center gap-2 md:gap-3">
                      ...
                      Hello, I&apos;m Benjamin Osondu(Emmylem)
                    </h3>
              ...
              <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                ...
                >
                  ...
                  <p className="text-gray-700 dark:text-gray-300 text-xs md:text-sm leading-relaxed mb-2 md:mb-3 flex-1">
                    Architecting and delivering scalable software solutions across industries, with a focus on web platforms, AI integration, and seamless cloud deployments. Emphasizing performance, maintainability, and technical precision in every build.
                  </p>
                ...
                >
                  ...
                  <p className="text-gray-700 dark:text-gray-300 text-xs md:text-sm leading-relaxed mb-2 md:mb-3 flex-1">
                    Spearheaded backend development for healthcare systems, integrating over 45 radiology machines and deploying modern HIMS and PACS platforms. Empowered cross-functional teams with training and scalable tech infrastructure.
                  </p>
                  <div className="flex items-center gap-2 text-xs md:text-sm mt-auto">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-50/90 to-pink-50/90 dark:from-purple-950/30 dark:to-pink-950/30 backdrop-blur-sm border border-white/30 dark:border-gray-700/40 shadow-xl">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div>
                    <div className="text-sm font-bold text-gray-900 dark:text-white break-all">bosondu55@gmail.com</div>
                  </div>
                </motion.a>
                ...
                >
                  ...
                  <div>
                    <div className="text-sm font-bold text-gray-900 dark:text-white">emmylem.dev</div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    <div className="text-sm font-bold text-gray-900 dark:text-white">Abuja, Nigeria</div>
                  </div>
                </motion.div>
              </div>
            </div>
