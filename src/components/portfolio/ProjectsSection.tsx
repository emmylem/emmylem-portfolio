...
const projects = [
  {
    title: "Aurally",
    subtitle: "Web3 Music Streaming & NFT Platform",
    description: "A pioneering Web3 platform built on the Algorand blockchain that redefines the music industry. Aurally empowers artists and fans with NFTs, stream-to-earn crypto rewards, and decentralized governance, creating a fairer and more engaging music ecosystem.",
    features: [
      "Decentralized Music & Video Streaming",
      "Integrated NFT Marketplace for minting and trading",
      "Stream-to-Earn model rewarding users with Aura tokens",
      "DAO Governance for community-led decision making",
      "Direct artist-to-fan engagement and communication channels",
      "Full content ownership and instantaneous payouts for artists",
      "Support for Algorand-compatible wallets like Pera and Defly"
    ],
    deliverables: [
      "Production-ready Web3 Decentralized Application (DApp)",
      "Secure smart contracts for NFTs and royalty distribution",
      "GraphQL API layer for seamless front-end data flow",
      "User authentication and profile management with JWT",
      "Scalable backend infrastructure using FastAPI and PostgreSQL"
    ],
    tech: ["Next.js", "FastAPI", "GraphQL", "PostgreSQL", "JWT Authentication", "Algorand Blockchain", "Tailwind CSS", "Web3.js", "Docker"],
    github: "https://github.com/your-repo/aurally", // <-- Update with your GitHub link
    live: "https://aurally.xyz",
  ...
  {
    title: "Gateh Global",
    subtitle: "Corporate Website for the Energy Sector",
    description: "Developed a professional and robust corporate website for Gateh Global, a leading Nigerian oil and gas company. The platform effectively establishes their digital presence, showcasing their core services like drilling, logistics, and project management to a global audience.",
    features: [
      "Fully responsive design for desktop, tablet, and mobile",
      "Detailed service pages outlining their industry expertise",
      "Dynamic project portfolio to showcase their impact",
      "Integrated contact forms and Google Maps for lead generation",
      "Easy-to-use Content Management System (CMS) for client updates",
      "Optimized for performance and search engine visibility (SEO)"
    ],
    deliverables: [
      "Fully deployed corporate website on a production server",
      "Customized WordPress theme tailored to the client's brand",
      "Mobile-first responsive interface",
      "Comprehensive admin panel for easy content management",
      "Training and documentation for the client team"
    ],
    tech: ["WordPress", "PHP", "CSS", "JavaScript", "MySQL", "Elementor"],
    github: "https://github.com/your-repo/gateh-global", // <-- Update with your GitHub link
    live: "https://gatehglobal.org",
    gradient: "from-blue-500 to-cyan-500",
    status: "Live",
    category: "Corporate Website",
    highlight: null, // This project is not highlighted as "Featured"
    timeline: "2 months",
    clientType: "Oil & Gas Industry"
  }
];
                ...
                <div className={`relative bg-gradient-to-br ${project.gradient} p-4 sm:p-6 md:p-8 lg:p-10`}>
                  ...
                  <div className="hidden md:block absolute inset-0 opacity-20 group-hover:opacity-30 transition-opacity duration-500">
                    {[
                      ...
                      { icon: "simple-icons:graphql", pos: { bottom: "10%", left: "70%" } },
                      { icon: "logos:docker-icon", pos: { top: "20%", right: "25%" } },
                      { icon: "logos:wordpress-icon", pos: { bottom: "25%", left: "90%" } },
                      { icon: "logos:php", pos: { top: "30%", right: "30%" } },
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                      ...
                      >
                        <Icon icon="solar:link-round-bold" width={18} height={18} className="md:w-5 md:h-5" />
                        <span>Live Site</span>
                      </Link>
                    </div>
                  </div>
