...
const techStackData: Record<string, TechItem[]> = {
  "Backend": [
    ...
    },
    {
      ...
      level: "Expert",
      category: "Backend",
      description: "Designing and implementing scalable RESTful and GraphQL APIs for modern web and mobile applications.",
      yearsUsed: 4
    }
  ...
  "Frontend": [
...

    {
      ...
      description: "Optimized for fast, expressive client-side development, powering Flutter apps across platforms.",
      yearsUsed: 3
    }
  ],
  "Database": [
...

    {
      ...
      level: "Expert",
      category: "Database",
      description: "Open-source Firebase alternative built on PostgreSQL, offering real-time data, auth, and serverless functions.",
      yearsUsed: 2
    },
